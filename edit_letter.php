                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="letter_about.php">Home</a>
                        </li>
                        <li>

                            <a href="letter_about.php">Letter from Chairman / About</a>
                        </li>
                            ...
                            <div class="row">
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    ?>
                                            ...
                                            <form class="form-horizontal" role="form"  method="post" action="update_letter.php" enctype="multipart/form-data">
                                                <table id="simple-table" class=" table-hover" style="width: 100%;">                                        
                                                    <tbody>
                                                        
                                                        <?php 
                                                        
                                                         $sqlcolumn = "SHOW COLUMNS FROM letter_from_chairman_about";
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right " for="form-field-1" style="text-align: left;">
                                                                     ...
                                                                     <input type="text"  id="form-field-1" name="editletter" 
                                                                               value="<?php echo $fields[1]; ?>" style="width:50%"/>
                                                                        
                                                                        <input type="hidden"  id="form-field-1" name="column_letter" 
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-9">
                                                                        ...
                                                                        <input type="hidden"  id="form-field-1" name="letter_id" 
                                                                               value="<?php echo $letter_id; ?>"/>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
