                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="current_events_kipling.php">Home</a>
                        </li>
                        <li>

                            <a href="current_events_kipling.php">Current Events / Kipling</a>
                        </li>

                        <li class="active">Edit Current Event</li>
                    </ul>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    $event_id = $_GET['id'];
                                    $sql = "SELECT * from current_events_kipling
                                                            where id =  " . $event_id;
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form class="form-horizontal" role="form"  method="post" action="update_current_event_kipling.php" enctype="multipart/form-data">
                                                <table id="simple-table" class=" table-hover" style="width: 100%;">                                        
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right " for="form-field-1" style="text-align: left;">Event Summary</label>
                                                                    <div class="col-xs-12 col-sm-9">
                                                                        <input type="text"  id="form-field-1" name="event_summary" 
