                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="lycee.php">Home</a>
                        </li>
                        <li>

                            <a href="lycee.php">Letter from Chairman / Lycee Voltaire</a>
                        </li>
                                ...
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form class="form-horizontal" role="form"  method="post" action="update_lycee.php" enctype="multipart/form-data">
                                                <table id="simple-table" class=" table-hover" style="width: 100%;">                                        
                                                    <tbody>
                                                        
                                                         <?php 
                                                        
                                                         $sqlcolumn = "SHOW COLUMNS FROM lycee";
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-9">
                                                                        ...
                                                                        <input type="hidden"  id="form-field-1" name="lycee_id" 
                                                                               value="<?php echo $lycee_id; ?>"/>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right " for="form-field-1" style="text-align: left;">
                                                                     ...
                                                                     <input type="text"  id="form-field-1" name="edithomologation" 
                                                                               value="<?php echo $fields[4]; ?>" style="width:50%"/>
                                                                        
                                                                        <input type="hidden"  id="form-field-1" name="column_homologation" 
                                                                               value="<?php echo $fields[4]; ?>"/>
                                                                    </label>
                                                                    <div class="col-xs-12 col-sm-9">
                                                                       
                                                                        <input type="text"  id="form-field-1" name="homologation" 
                                                                               value="<?php echo $row["$fields[4]"]; ?>"  style="width:50%"/>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
