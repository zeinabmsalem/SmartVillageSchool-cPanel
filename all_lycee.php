        ...
        <div class="container" id="Services" style=" padding-top: 120px;padding-bottom: 150px;  ">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 80px;padding-left:40px;padding-right: 40px">
                        <div class="card-img iconbox mcenter"><a href="home_lycee.php" class="fa fa-map-o  fa-4x" style="color:#e40405;  font-size:9em;"></a>  
                        </div>
                ...
                <div class="col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 80px;padding-left:40px;padding-right: 40px">
                        <div class="card-img iconbox mcenter"><a href="activites_lycee.php" class="fa fa-map-o  fa-4x" style="color:#e40405;  font-size:9em;"></a>  
                        </div>
                         <div class="card-block mcenter">
                  ...
                  <div class="col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 80px;padding-left:40px;padding-right: 40px">
                        <div class="card-img iconbox mcenter"><a href="alumni_lycee.php" class="fa fa-map-o  fa-4x" style="color:#e40405;  font-size:9em;"></a>  
                        </div>
                         <div class="card-block mcenter">
...
<!--                    <div class="col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 80px;padding-left:40px;padding-right: 40px">
                        <div class="card-img iconbox mcenter"><a href="lycee.php" class="fa fa-map-o  fa-4x" style="color:#e40405;  font-size:9em;"></a>  
                        </div>
                         <div class="card-block mcenter">
                ...
                <div class="col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 80px;padding-left:40px;padding-right: 40px">
                        <div class="card-img iconbox mcenter"><a href="endpage_lycee.php" class="fa fa-map-o  fa-4x" style="color:#e40405;  font-size:9em;"></a>  
                        </div>
                         <div class="card-block mcenter">
                          <h4 class="card-title">Endpage for Lycee</h4>
                         </div>
