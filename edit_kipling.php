                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="kipling.php">Home</a>
                        </li>
                        <li>

                            <a href="kipling.php">Letter from Chairman</a>
                        </li>

                        <li class="active">Edit Letter from Chairman</li>
                    </ul>
                                ...
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form method="post" action="update_kipling.php" class="form-horizontal" enctype="multipart/form-data">
                                                <table id="simple-table" class=" table-hover" style="width: 100%;">                                        
                                                    <tbody>
                                                        
                                                        <?php 
                                                        
                                                         $sqlcolumn = "SHOW COLUMNS FROM kipling_school_homepage";
                                                         $resultcolumnnames = mysqli_query($conn, $sqlcolumn);
                                    
                                                         while ($record = mysqli_fetch_array($resultcolumnnames)){
                                                          $fields[] = $record['0']; 
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style="text-align: left;">
                                                                        ...
                                                                        <input type="text"  id="form-field-1" name="editmission" 
                                                                               value="<?php echo $fields[1]; ?>" style="width:50%"/>
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-9">
                                                                        <input type="text"  id="form-field-1" name="mission" 
                                                                               value="<?php echo $row["$fields[1]"]; ?>" style="width:50%"/>
                                                                        
                                                                        <input type="hidden"  id="form-field-1" name="kipling_id" 
                                                                               value="<?php echo $kipling_id; ?>"/>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right " for="form-field-1" style="text-align: left;">
                                                                       <input type="text"  id="form-field-1" name="editvision" 
                                                                               value="<?php echo $fields[2]; ?>" style="width:50%"/>  
                                                                       
                                                                        <input type="hidden"  id="form-field-1" name="column_vision" 
                                                                               value="<?php echo $fields[2]; ?>"/>
                                                                    </label>
                                                                    
                                                                    <div class="col-xs-12 col-sm-9">
                                                                        <input type="text"  id="form-field-1" name="vision" 
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right " for="form-field-1" style="text-align: left;">
                                                                     <input type="text"  id="form-field-1" name="editaccreditation" 
                                                                               value="<?php echo $fields[3]; ?>" style="width:50%"/>   
                                                                     
                                                                      <input type="hidden"  id="form-field-1" name="column_accreditation" 
                                                                               value="<?php echo $fields[3]; ?>"/>
                                                                    </label>
                                                                    
                                                                    <div class="col-xs-12 col-sm-9">
                                                                        <input type="text"  id="form-field-1" name="accreditation" 
                                                                               value="<?php echo $row["$fields[3]"]; ?>"  style="width:50%"/>                             
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                             ...
                                                             <td>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right " for="form-field-1" style="text-align: left;">
                                                                        ...
                                                                        <input type="text"  id="form-field-1" name="editimage" 
                                                                               value="<?php echo $fields[4]; ?>" style="width:50%"/>  
                                                                     
                                                                     <input type="hidden"  id="form-field-1" name="column_image" 
