                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb" style="background-color: #fc0000">
                            <li>
                                ...
                                <a href="activites_lycee.php">Home</a>
                            </li>
                            <li class="active"> <a href="activites_lycee.php">Edit Lycee Voltaire / Activites</a></li>
                        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-content" style="margin-top: 20px;">
                        ...
                        <div class="row">
                            <div class="col-12">
                               ...
                               <form method="post" action="update_lycee_Activites.php?id=<?php echo $image_id; ?>" enctype="multipart/form-data">
                                <div class="row">

                                    <div class="col-12 col-md-9">
                                        <!-- Image -->
                                        <label for="website-image">Image</label>
                                        <input type="file" id="website_image" name="image" class="form-control" placeholder="IMAGE" required style="width:400px; height:40px;">
                                    </div>
