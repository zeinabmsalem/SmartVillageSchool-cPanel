    ...
    <body class="no-skin" style="background-color:White">
            <div class="main-content" style="height: 766px;">
                <div class="main-content-inner">
                        ...
                        <ul class="breadcrumb">
                            <li>
                              ...
                              <li>
                                  ...
                                  <a href="current_events.php">Current Event</a>
                            </li>


                            <li class="active">Delete Current Event</li>
                        </ul>
                    ...
                    $strId_sql = "SELECT * from current_events
                                    where id =  " . $event_id;
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-offset-3 col-md-6 widget-container-col" id="widget-container-col-4" style="margin-top: 150px;margin-bottom:150px ">
                                <div class="widget-box" id="widget-box-4">
                                    <div class="widget-header widget-header-large">
                                        <h4 class="widget-title" style="font-weight: bold;color: #fc0000;">Delete Current Event !</h4>
                                        ...
                                        <div class="widget-main">
                                            <center>
                                                <p class="alert alert-info" style="border-color: white;background-color: white;" >
                                                    ...
                                                    Are you sure you want to delete Current Event: <b><?php echo $row["summary"]; ?> </b> with ID: <?php echo $row["id"]; ?>
                                    ...
                                    <div class="padding-8 clearfix" style="padding:30px">
                                        ...
                                        <a href="delete_current_event.php?id=<?php echo $row["id"]; ?>">  
