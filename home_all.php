        ...
        <div class="container" id="Services" style=" padding-top: 120px;padding-bottom: 150px;  ">
            <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 80px;padding-left:40px;padding-right: 40px">
                        <div class="card-img iconbox mcenter"><a href="current_events.php" class="fa fa-map-o  fa-4x" style="color:#e40405;  font-size:9em;"></a>  
                        </div>
                ...
                <div class="col-xs-12 col-lg-4" style="padding-top: 80px; padding-bottom: 80px;padding-left:40px;padding-right: 40px">
                    <div class="card-img iconbox mcenter"><a href="upcoming_events.php" class="fa fa-map-o  fa-4x" style="color:#e40405 ;     font-size:9em;"></a></div>
                    <div class="card-block mcenter">
