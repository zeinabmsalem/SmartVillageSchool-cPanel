                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="endpage_lycee.php">Home</a>
                        </li>
                        <li>

                            <a href="endpage_lycee.php">Endpage / Lycee Voltaire</a>
                        </li>

                        <li class="active">Edit Endpage of Lycee Voltaire</li>
                    </ul>
                                ...
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form class="form-horizontal" role="form"  method="post" action="update_endpage_lycee.php" enctype="multipart/form-data">
