    ...
    <body class="no-skin" style="background-color:White">
            <div class="main-content" style="height: 766px;">
                <div class="main-content-inner">
                        ...
                        <ul class="breadcrumb">
                            <li>
                              ...
                              <li>
                                  ...
                                  <a href="kipling.php">Kipling School</a>
                            </li>


                            <li class="active">Delete Kipling School</li>
                        </ul>
                    ...
                    $strId_sql = "SELECT * from kipling_school_homepage
                                    where id =  " . $image_id;
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-offset-3 col-md-6 widget-container-col" id="widget-container-col-4" style="margin-top: 150px;margin-bottom:150px ">
                                <div class="widget-box" id="widget-box-4">
                                    <div class="widget-header widget-header-large">
                                        <h4 class="widget-title" style="font-weight: bold;color: #fc0000;">Delete Kipling Record !</h4>
                                        ...
                                        <div class="widget-main">
                                            <center>
                                                <p class="alert alert-info" style="border-color: white;background-color: white;" >
                                                    ...
                                                    Are you sure you want to delete Kipling Record with ID: <?php echo $row["id"]; ?>
                                    ...
                                    <div class="padding-8 clearfix" style="padding:30px">
                                        ...
                                        <a href="delete_kipling.php?id=<?php echo $row["id"]; ?>">  
