                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="endpage_alumni_kipling.php">Home</a>
                        </li>
                        <li>

                            <a href="endpage_alumni_kipling.php">Endpage of Alumni / Kipling</a>
                        </li>

                        <li class="active">Edit Endpage of Alumni</li>
                    </ul>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    $kipling_id = $_GET['id'];
                                    $sql = "SELECT * from endpage_alumni_kipling
                                                            where id =  " . $kipling_id;
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                    <form class="form-horizontal" role="form"  method="post" action="update_endpage_alumni_kipling.php" enctype="multipart/form-data">
                                                <table id="simple-table" class=" table-hover" style="width: 100%;">                                        
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right " for="form-field-1" style="text-align: left;">Name</label>
                                                                    <div class="col-xs-12 col-sm-9">
                                                                       
                                                                        <input type="text"  id="form-field-1" name="name" 
                                                                               value="<?php echo $row["name"]; ?>" style="width:50%"/>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right " for="form-field-1" style="text-align: left;">Title</label>
                                                                    <div class="col-xs-12 col-sm-9">
