                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="endpage_alumni_lycee.php">Home</a>
                        </li>
                        <li>

                            <a href="endpage_alumni_lycee.php">Endpage of Alumni / Lycee Voltaire</a>
                        </li>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    $lycee_id = $_GET['id'];
                                    $sql = "SELECT * from endpage_alumni_lycee
                                                            where id =  " . $lycee_id;
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form class="form-horizontal" role="form"  method="post" action="update_endpage_alumni_lycee.php" enctype="multipart/form-data">
