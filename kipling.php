                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb" style="background-color: #fc0000">
                            <li>
                                ...
                                <a href="home_kipling.php">Home</a>
                            </li>
                            <li class="active">Letter from Chairman / Kipling</li>
                        </ul><!-- /.breadcrumb -->
                                                   ...
                                                   $sql = "SELECT * from kipling_school_homepage";
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="center">
                                                                 <img src="<?php echo $row["$fields[4]"]; ?>" width="100" height="100"/>
                                                            </td>
                                                            
                                                            <td class="center">
                                                                <a href="edit_kipling.php?id=<?php echo $row["id"]; ?>">
