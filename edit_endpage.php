                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="end_activites.php">Home</a>
                        </li>
                        <li>

                            <a href="end_activites.php">End of Activites</a>
                        </li>

                        <li class="active">Edit End of Activites</li>
                    </ul>
                                ...
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                    <form class="form-horizontal" role="form"  method="post" action="update_endpageactivites.php" enctype="multipart/form-data">
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-9">
                                                                        ...
                                                                        <input type="hidden"  id="form-field-1" name="activity_id" 
