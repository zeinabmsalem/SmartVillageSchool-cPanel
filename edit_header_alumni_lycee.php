                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="header_alumni_lycee.php">Home</a>
                        </li>
                        <li>

                            <a href="header_alumni_lycee.php">Header of Alumni / Lycee Voltaire</a>
                        </li>
                                ...
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                    <form class="form-horizontal" role="form"  method="post" action="update_header_alumni_lycee.php" enctype="multipart/form-data">
