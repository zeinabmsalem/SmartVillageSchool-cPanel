                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="popular_articles.php">Home</a>
                        </li>
                        <li>

                            <a href="popular_articles.php">Popular Articles</a>
                        </li>

                        <li class="active">Edit Popular Articles</li>
                    </ul>
                                ...
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form method="post" action="update_popular_articles.php" class="form-horizontal" enctype="multipart/form-data">
