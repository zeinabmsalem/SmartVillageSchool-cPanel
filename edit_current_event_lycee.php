                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="current_events_lycee.php">Home</a>
                        </li>
                        <li>

                            <a href="current_events_lycee.php">Current Events / Lycee Voltaire</a>
                        </li>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    $sql = "SELECT * from current_events_lycee
                                                            where id =  " . $event_id;
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form class="form-horizontal" role="form"  method="post" action="update_current_event_lycee.php" enctype="multipart/form-data">
