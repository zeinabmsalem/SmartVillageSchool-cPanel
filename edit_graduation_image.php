                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb"style="background-color: #fc0000">
                            <li>
                                ...
                                <a href="graduation_image.php">Home</a>
                            </li>
                            <li class="active"> <a href="graduation_image.php">Edit Graduation Image</a></li>
                        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-content" style="margin-top: 20px;">
                        ...
                        <div class="row">
                            <div class="col-12">
                               ...
                               <form method="post" action="update_graduation_image.php?id=<?php echo $image_id; ?>" enctype="multipart/form-data">
                                <div class="row">

                                    <div class="col-12 col-md-9">
                                        <!-- Image -->
                                        <label for="website-image">Image</label>
                                        <input type="file" name="image" class="form-control" placeholder="IMAGE" required style="width:400px; height:40px;">
                                    </div>
