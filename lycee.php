                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb" style="background-color: #fc0000">
                            <li>
                                ...
                                <a href="home_lycee.php">Home</a>
                            </li>
                            <li class="active">Letter from Chairman / Lycee Voltaire</li>
                        </ul><!-- /.breadcrumb -->
                                                   ...
                                                   $sql = "SELECT * from lycee";
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="center">
                                                                 <img src="<?php echo $row["$fields[1]"]; ?>" width="100" height="100"/>
                                                                
                                                            </td>
                                                            
                                                            <td class="center">
                                                               <?php echo $row["$fields[2]"]; ?>
                                                            </td>
                                                            ...
                                                            <td class="center">
                                                                <?php echo $row["$fields[4]"]; ?>
                                                            </td>
                                                            
                                                            <td class="center">
                                                                <a href="edit_lycee.php?id=<?php echo $row["id"]; ?>">

                                                                 <img src="updateicon.svg" width="40px" height="40px"/>
                                                                </a>

<!--                                                                <a href="delete_kipling_confirmation.php?id=<?php echo $row["id"]; ?>">
