                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb" style="background-color: #fc0000">
                            ...
                            <li class="active">Kipling / Activites</li>
                        </ul><!-- /.breadcrumb -->
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                   $sql = "SELECT * from kipling_activites";
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="center">
                                                                <a href="edit_kipling_activites.php?id=<?php echo $row["id"]; ?>">

                                                                 <img src="updateicon.svg" width="40px" height="40px"/>
                                                                </a>

<!--                                                                <a href="delete_image_confirmation.php?id=<?php echo $row["id"]; ?>">
                          ...
                          <!--<a href="add_image.php"><button class="btn btn-primary">Add Image</button></a>-->
