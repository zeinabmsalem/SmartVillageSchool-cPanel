                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="header_about.php">Home</a>
                        </li>
                        <li>

                            <a href="header_about.php">Header / About</a>
                        </li>
                                ...
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                    <form class="form-horizontal" role="form"  method="post" action="update_header_about.php" enctype="multipart/form-data">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                         ...
                                                         <tr>
                                                            <td>
                                                                <div class="form-group">
                                                                    <label class="col-sm-3 control-label no-padding-right " for="form-field-1" style="text-align: left;">Content</label>
                                                                    <div class="col-xs-12 col-sm-9">
                                                                        
                                                                        <input type="text"  id="form-field-1" name="content" 
                                                                               value="<?php echo $row["content"]; ?>" style="width:50%"/>
