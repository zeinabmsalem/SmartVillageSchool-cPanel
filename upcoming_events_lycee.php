                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb"style="background-color: #fc0000">
                            ...
                            <li class="active">Upcoming Events / Lycee Voltaire</li>
                        </ul><!-- /.breadcrumb -->
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td class="center">
                                                            ...
                                                            <td class="center">
                                                                <a href="edit_upcoming_lycee.php?id=<?php echo $row["id"]; ?>">

                                                                 <img src="updateicon.svg" width="40px" height="40px"/>
                                                                </a>

<!--                                                                <a href="delete_event_confirmation.php?id=<?php echo $row["id"]; ?>">
