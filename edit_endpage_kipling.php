                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="endpage_kipling.php">Home</a>
                        </li>
                        <li>

                            <a href="endpage_kipling.php">Endpage</a>
                        </li>

                        <li class="active">Edit Endpage</li>
                    </ul>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    $kipling_id = $_GET['id'];
                                    $sql = "SELECT * from endpage_kipling
                                                            where id =  " . $kipling_id;
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form class="form-horizontal" role="form"  method="post" action="update_endpage_kipling.php" enctype="multipart/form-data">
