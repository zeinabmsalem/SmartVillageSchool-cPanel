                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        <li>
                            ...
                            <a href="last_articles.php">Home</a>
                        </li>
                        <li>

                            <a href="last_articles.php">Last Articles</a>
                        </li>

                        <li class="active">Edit Last Articles</li>
                    </ul>
                                ...
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form method="post" action="update_last_articles.php" class="form-horizontal" enctype="multipart/form-data">
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-9">
                                                                        ...
                                                                        <input type="hidden"  id="form-field-1" name="activites_id" 
