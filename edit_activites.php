            ...
            <div class="main-content-inner">
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Edit Activites</li>
                    </ul>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-10 col-xs-offset-1 col-md-11">
                                    ...
                                    $activites_id = $_GET['id'];
                                    
                                    $sql = "SELECT * from activites
                                                            where id =  " . $activites_id;
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                            <form method="post" action="update_activites.php" class="form-horizontal" enctype="multipart/form-data">
